-- Migration 0021: Recriar v_processos com colunas atualizadas.
-- Corrige: st.codigo → st.nome_solucao e nt.codigo → nt.nome_natureza
...
SELECT
    ...
    st.nome_solucao                              AS solucao_tipo,
    nt.nome_natureza                             AS natureza_processo,
    t.numero,
    t.processo_sei,
    t.responsavel_id,
    t.data_instauracao,

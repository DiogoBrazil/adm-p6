        ...
        async {
            ...
            audit_repository::registrar(
                ...
                Acao {
                    ...
                    acao: if existente { "Editou o cadastro do policial militar" } else { "Cadastrou o policial militar" },
                    assunto,
                    alteracoes: None,
                },
                Some(&actor.id),
        ...
        async {
            ...
            audit_repository::registrar(
                ...
                Acao {
                    ...
                    operacao: "UPDATE",
                    acao: "Desativou o policial militar",
                    assunto,
                    alteracoes: None,
                },
                Some(&actor.id),
        ...
        async {
            ...
            audit_repository::registrar(
                ...
                Acao {
                    ...
                    registro_id: &id,
                    operacao: "DELETE",
                    acao: "Excluiu o policial militar",
                    assunto,
                    alteracoes: None,
                },
                Some(&actor.id),
        ...
        async {
            ...
            audit_repository::registrar(
                ...
                Acao {
                    ...
                    registro_id: &id,
                    operacao: "UPDATE",
                    acao: "Reativou o policial militar",
                    assunto,
                    alteracoes: None,
                },
                Some(&actor.id),

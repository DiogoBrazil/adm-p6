...
pub fn registrar_comandos<R: tauri::Runtime>(builder: tauri::Builder<R>) -> tauri::Builder<R> {
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            apuratorio_config::commands::apuratorio_config_delete_documento,
            apuratorio_config::commands::apuratorio_config_delete_papel,
            ...
            files::commands::files_generate_spreadsheet,

-- ============================================
-- MIGRAÇÃO 019: Tornar responsavel opcional (PAD/CD/CJ)
-- ============================================
-- Objetivo: Permitir que processos PAD, CD e CJ não tenham "Encarregado".
-- Ajustes:
--  - Remover NOT NULL de responsavel_id e responsavel_tipo
--  - Manter CHECK de responsavel_tipo (aceita NULL)
--  - Preservar colunas de papéis específicos (presidente/interrogante/escrivao_processo)
...
ALTER TABLE processos_procedimentos RENAME TO processos_procedimentos_old_019;

-- Recriar tabela com responsavel_id/responsavel_tipo opcionais
...
FROM processos_procedimentos_old_019;

-- Remover tabela antiga
DROP TABLE processos_procedimentos_old_019;
...
VALUES ('019_responsavel_optional.sql', CURRENT_TIMESTAMP, 0, 1);
